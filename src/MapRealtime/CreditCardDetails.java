...
public class CreditCardDetails {
	...
	public static void main(String[] args) {
		...
		ArrayList<CreditCard> listOfCreditCards1 = new ArrayList<CreditCard>();
		...
		mapObject.put(11111111l, listOfCreditCards1);
		mapObject.put(22222222l, listOfCreditCards2);
		mapObject.put(33333333l, listOfCreditCards3);
		mapObject.put(44444444l, listOfCreditCards4);
